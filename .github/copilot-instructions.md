...
- Neste repositório, evitar ao máximo Primitive Obsession. Preferir Value Objects com validações internas para evitar Primitive Obsession, deixando as entidades focadas em comportamento e regras do agregado. Preferir utilizar records ao invés de classes para Value Objects quando fizer sentido neste projeto. O domínio deve ser rico, com entidades, comportamentos, validações, erros e exceções bem definidos. Padronizar requests/responses da API e a tratativa de erros para o frontend.
